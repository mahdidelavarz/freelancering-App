  ...
  return (
    open && (
      <div className="backdrop-blur-sm fixed top-0 left-0 w-full h-screen bg-gray-800 bg-opacity-40 z-50">
        <div
          ref={modalRef}
          className="fixed w-[calc(100vw-2rem)] md:w-96 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-4 shadow-lg shadow-slate-400 transition-all duration-500 ease-out"
        >
